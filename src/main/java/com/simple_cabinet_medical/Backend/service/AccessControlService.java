...
public class AccessControlService {
    ...
    public boolean hasAccess(BasedObject obj, Long idUtilisateur, EAccessLevel accessLevel) {
        ...
        if (obj instanceof Ordonnance) {
            return checkOrdonnanceAccess((Ordonnance) obj, utilisateur, accessLevel);
        }
    ...
    private boolean checkOrdonnanceAccess(Ordonnance ordonnance, Utilisateur utilisateur, EAccessLevel accessLevel) {
        if (accessLevel.equals(EAccessLevel.WRITE) || accessLevel.equals(EAccessLevel.DELETE) || accessLevel.equals(EAccessLevel.UPDATE)) {
            return utilisateur.getRole().equals(EROLE.MEDECIN) || ordonnance.getIdUtilisateur().equals(utilisateur.getIdUtilisateur());
        }
        if (accessLevel.equals(EAccessLevel.READ)) {
            return utilisateur.getClient().equals(utilisateurRepository.findById(ordonnance.getIdUtilisateur()).get().getClient());
        }
        return false;
    }
